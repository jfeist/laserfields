program test_field_values
  ...
  integer, parameter :: nfields = 5, nsamples = 3
  ...
  lfs(5) = make_laserfield('linear2', intensity_wcm2, lambda_nm, t0_ref/au_as, duration_flat_as, &
  ...
  expected_e(5,:) = (/ -0.4635254915624215d0, 1.213525491562421d0, 0.4635254915624302d0 /)
  ...
  expected_a(5,:) = (/ 11.888206453689419d0, 7.347315653655915d0, -11.888206453689396d0 /)
  ...
  expected_ep(5,:) = (/ (-0.23176274578121075d0, 0.7132923872213651d0), (0.6067627457812105d0, 0.4408389392193549d0), (0.2317627457812151d0, -0.7132923872213638d0) /)
  ...
  expected_ap(5,:) = (/ (5.944103226844709d0, 1.9313562148434231d0), (3.6736578268279576d0, -5.0563562148434205d0), (-5.944103226844698d0, -1.9313562148434595d0) /)
